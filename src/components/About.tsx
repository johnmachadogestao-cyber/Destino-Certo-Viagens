    ...
    <section className="py-10 bg-blue-50">
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-8 items-center">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-serif font-bold text-blue-950 mb-4">Nossa História</h2>
          <div className="space-y-4 text-base md:text-lg text-gray-850 font-sans leading-relaxed">
            <p>
