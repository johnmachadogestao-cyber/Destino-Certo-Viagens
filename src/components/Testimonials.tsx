...
export default function Testimonials() {
  ...
  return (
    <section id="feedbacks" className="py-10 bg-blue-100 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
        ...
        <div className="relative max-w-xl mx-auto px-1 sm:px-4">
          <div 
            className="relative overflow-hidden rounded-3xl shadow-2xl border-4 border-gray-100 bg-white aspect-[3/4] md:aspect-[4/5] cursor-grab active:cursor-grabbing"
        ...
        <div className="mt-10 relative w-full overflow-hidden py-4 bg-white rounded-2xl flex items-center">
